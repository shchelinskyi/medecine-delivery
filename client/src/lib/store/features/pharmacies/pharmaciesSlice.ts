...
export const fetchPharmacyProducts = createAsyncThunk(
    ...
    async (pharmacyId:string) => {
        const response = await axios.get(`http://localhost:3001/api/inventories/${pharmacyId}/products`);
        return response.data;
    }
);
...
export const fetchPharmacyProductsUp = createAsyncThunk(
    ...
    async (pharmacyId:string) => {
        const response = await axios.get(`http://localhost:3001/api/inventories/${pharmacyId}/products/sortedUp`);
        return response.data;
    }
);
...
export const fetchPharmacyProductsDown = createAsyncThunk(
    ...
    async (pharmacyId:string) => {
        const response = await axios.get(`http://localhost:3001/api/inventories/${pharmacyId}/products/sortedDown`);
        return response.data;
    }
);
